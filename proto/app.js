...
function screenProfile() {
  ...
  const dateField = (label, key, help, back, ahead) => `
    <div class="card flat" style="margin-bottom:8px">
      ...
      ${dateSelects('parent:' + key, p[key] || '', back, ahead)}
  ...
  <div class="sc">
    ...
    ${store.children.map((k) => `
      <div class="card" style="margin-bottom:10px">
        ...
        <div style="margin-top:9px">
          <span class="tiny" style="display:block;margin-bottom:5px">Birthday, or a due date if you are expecting</span>
          ${dateSelects('child:' + k.id, k.birthday || '', 25, 1)}
        </div>
    ...
    <div class="card">
      ...
      <div style="margin-top:8px">${dateSelects('draft', store.draftChildBday || '', 25, 1)}</div>
      <p class="tiny" style="margin-top:8px">
...
function bdayStartArt() {
  ...
  const frame = () => {
    ...
    balloons.forEach((b) => {
      ...
      if (b.y - b.r > H) { b.y = -b.r - rand(0, H * 0.6); b.x = rand(b.r + 8, W - b.r - 8); }
