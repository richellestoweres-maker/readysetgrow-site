...
export const VAX_VISITS = [
  ...
  { id: 'm18', label: 'The second hepatitis A', when: 'At least 6 months after the first one', from: 21, to: 59.9 },
  ...
  { id: 'y12', label: 'The follow up after that one', when: '6 to 12 months later', from: 144, to: 191.9 },
  { id: 'y16', label: 'The 16 year visit', when: '16 years', from: 192, to: 195.9 },
  { id: 'y17', label: 'The last of them', when: '16 to 18 years', from: 196, to: 400 },
];
